...
"""Stage bridge from JoyAI actions to Qwen3-TTS."""
...
def joyai2tts(
    ...
    """Speak response text or a delegate note; silence skips TTS."""
    ...
    if not sources:
        return []
    return aura2tts(sources, prompt=tts_prompts, requires_multimodal_data=False)
